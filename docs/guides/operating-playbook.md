...
`run --help` and `run -h` print the CLI usage text instead of trying to resolve the flag as a preset.
...
- Verify you are running the updated `./bin/miniloops` from this repo/worktree, not an older checkout
