...
Global rules:
- Shared working files are the source of truth: `sec-findings.md`, `sec-report.md`, `progress.md`.
...
State files:
- `sec-findings.md` — raw findings from scanning: location, type, severity, evidence.
- `sec-report.md` — compiled security report: confirmed findings, fixes applied, remaining risks.
- `progress.md` — current finding being analyzed, what the next role should do.