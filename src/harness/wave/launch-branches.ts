...
import { readIfExists, appendEvent, extractField } from "../journal.js";
import { parallelDispatchBase } from "../emit.js";
import { runProcess, writeParallelBranchSummary, renderBranchResult } from "../parallel.js";
import type { LoopContext } from "../types.js";
import type { IterationContext } from "../prompt.js";
import type { BranchSpec, BranchResult } from "./types.js";

export function prepareParallelBranches(loop: LoopContext, iter: IterationContext, waveId: string, waveDir: string, emittedTopic: string, objectives: string[]): BranchSpec[] {
...
export function launchParallelBranches(loop: LoopContext, specs: BranchSpec[]): BranchSpec[] {
...
export function joinParallelBranches(loop: LoopContext, iter: IterationContext, waveId: string, pending: BranchSpec[]): BranchResult[] {
