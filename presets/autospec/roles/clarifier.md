...
On every activation:
- Read `spec-brief.md`, `spec-research.md`, and `progress.md` if they exist.
...
- Create or refresh `spec-brief.md` with:
  - Objective
  - Source Material
  - Proposed Title
  - Slug
...
- Update `progress.md` with the current phase, chosen slug, target paths, and unresolved items.
