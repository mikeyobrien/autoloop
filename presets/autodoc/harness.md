...
Global rules:
- Shared working files are the source of truth: `.miniloop/doc-plan.md`, `.miniloop/doc-report.md`, `.miniloop/progress.md`.
...
- The writer should leave a claim-level verification checklist in `.miniloop/progress.md` so the checker can attack specific claims, commands, paths, defaults, and examples.
...
State files:
- `.miniloop/doc-plan.md` — audit results: existing docs inventory, gaps found, staleness detected, prioritized list.
- `.miniloop/doc-report.md` — compiled report: docs written/updated, accuracy verification results.
- `.miniloop/progress.md` — current gap being addressed, what the next role should do.
