...
Global rules:
- Shared working files are the source of truth: `.miniloop/review-context.md`, `.miniloop/review-findings.md`, `.miniloop/progress.md`.
...
State files:
- `.miniloop/review-context.md` — the diff, affected files, surrounding context, and architectural notes.
- `.miniloop/review-findings.md` — structured findings with severity, location, description, and suggested fix.
- `.miniloop/progress.md` — current review pass, what the next role should do.