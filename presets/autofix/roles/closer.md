...
2. Update `.miniloop/fix-log.md` with:
   - Bug description
   - Root cause
   - Fix applied (files changed, what changed)
   - Verification result
3. Make sure `.miniloop/progress.md` exists and names the next action using the exact on-disk bug-report path.
