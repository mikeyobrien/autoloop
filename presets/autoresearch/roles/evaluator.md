...
2. Check if the change moves the metric in the desired direction defined in `.miniloop/autoresearch.md`.
...
6. Append a result line to `.miniloop/experiments.jsonl`:
   `{"id":N, "hypothesis":"...", "change":"...", "metric_before":..., "metric_after":..., "verdict":"keep|discard", "reason":"..."}`
7. Update `.miniloop/progress.md` with the verdict and reasoning.
...
- Always append to `.miniloop/experiments.jsonl` before emitting.
